...
public class genSieve {
  ...
  public static void permutateFile(File file) throws IOException {
  	...
  	Character c2 = (char)(r.nextInt(26) + 'a');
  	
    try (BufferedReader br = new BufferedReader(new FileReader("SieveTemplate.java"))) {
  	  String line;
  	  
  	  while ((line = br.readLine()) != null) {
  	  	bw.write(line.replaceAll("X", Character.toString(c))
  	  				 .replaceAll("Y", Character.toString(c2))
  	  				 .replaceAll("2", Integer.toString((int)(Math.random() * 101))));
  	  	bw.newLine();
  	  }
